...
DECLARE parent_description TEXT := 'Liping General Dealer Carolina'; -- NOTE!!! Please go check the ENTITY table first to see if a parent already exists
...
DECLARE ocs_ed_ws_gc TEXT := 'CHIUNION6';
DECLARE ocs_ed_ws_usr TEXT := 'LipingCarolina';
DECLARE ocs_ed_ws_pwd TEXT := '9f65a1d9d91ff2d5a23ab273c30f80239b854f8f3eec64a6658046c083b3527c';
DECLARE ocs_df_scheme TEXT := 'CHIUNION6'; --This is what the scheme name is which maps back to the Easy Debit Group code. We set to settings to act as a default value to be used for children inheritting from a paremt
DECLARE ocs_ed_sc_gc_map TEXT:= '[{"map": "CHIUNION6", "gc": "CHIUNION6"}]'; 
...
DECLARE ocs_ed_do_sc_gc_map TEXT:= '[{"map": "CU6EFT", "gc": "CU6EFT"}]';
DECLARE ocs_ed_do_gc TEXT:= 'CU6EFT';
...
-- CRS Settings 
-- Set settings here by adding := '...'; 
DECLARE crs_cpb_enquiry_done_by TEXT := 'Liping General Dealer Carolina';
