...
DECLARE parent_description TEXT := 'EasyLoans'; -- NOTE!!! Please go check the ENTITY table first to see if a parent already exists
...
DECLARE ocs_ed_ws_gc TEXT := 'EDDebi';
DECLARE ocs_ed_ws_usr TEXT := 'EDDebi';
DECLARE ocs_ed_ws_pwd TEXT := '7ce293ee86e80dde6ed166b3d26a92708859286049fff43a67d83799569798ac';
DECLARE ocs_df_scheme TEXT := 'EDDebi'; --This is what the scheme name is which maps back to the Easy Debit Group code. We set to settings to act as a default value to be used for children inheritting from a paremt
DECLARE ocs_ed_sc_gc_map TEXT:= '[{"map": "EDDebi", "gc": "EDDebi"}]'; 
...
DECLARE ocs_ed_do_sc_gc_map TEXT:= '[{"map": "EDEFT", "gc": "EDEFT"}]';
DECLARE ocs_ed_do_gc TEXT:= 'EDEFT';
...
-- CRS Settings 
-- Set settings here by adding := '...'; 
DECLARE crs_cpb_enquiry_done_by TEXT := 'Bitventure';
